...
## Softwaresikkerhed d. 10. februar
<img width="1246" height="642" alt="image" src="https://github.com/user-attachments/assets/6cdb8766-9071-4f18-b47b-c58ce9354a3e" />

## Opgave - Flat File (Svær)
Udarbejdet af Nichlas Damgaard og Amalie Asborg Hansen

### Hvorfor er det smart at bruge en flat_file_db?
En flat file er en simpel datafil, der kan bruges til at gemme information. Det smarte ved en flat file er, at man kan gemme al information i ét enkelt lag i sit program. Dette gør det perfekt til simple applikationer, hvor man gemmer sin "database" i samme repository som det dertilhørende program. Vi valgte at gemme vores data i vores flat_file_db som struktureret data ved at gemme det i en JSON-fil.

### Valg af testteknik:
For at finde ud af hvilke funktioner vores database skulle have, valgte vi at bruge testteknikken CRUD(L), fordi vi skal arbejde med data og derfor gerne vil kunne behandle disse.

### Screenshots af unittests med testnavne, risici, og given-when-then:

Opsætning:

<img width="791" height="826" alt="image" src="https://github.com/user-attachments/assets/ab885ad3-0689-4b0b-897d-fc9188f8caa6" />

Unit tests:

<img width="966" height="846" alt="image" src="https://github.com/user-attachments/assets/0c6bda3c-514f-4fe8-9768-20337bd768a7" />

Resultat af kørte unit tests i terminalen:

<img width="762" height="182" alt="image" src="https://github.com/user-attachments/assets/99be3e61-2e2f-47ca-b7b0-6638740b6953" />
